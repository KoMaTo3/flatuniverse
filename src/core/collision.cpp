...
=============
  Update
  ќбновление состо€ни€ объекта:
    перерасчет скоростей, положени€, дополнительных значений
=============
*/
...
=============
  TestIntersect
  “ест пересечени€ коллизии с пр€моугольной областью
=============
*/
...
=============
  ...
  square + square
  ¬ эту функцию мы попадаем уже пройд€ первоначальную проверку по квадратам, остаЄтс€ только вернуть решение
=============
*/
